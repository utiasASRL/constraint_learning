...
if __name__ == "__main__":
    ...
    run_stereo_study(n_seeds=n_seeds, recompute=recompute, tightness=True, scalability=True)
    run_range_only_study(n_seeds=n_seeds, recompute=recompute, tightness=True, scalability=True)
    run_other_study(n_seeds=n_seeds, recompute=recompute, tightness=True, scalability=True)
