...
Lifters = [
    #(Poly4Lifter, dict()),
    #(Poly6Lifter, dict()),
    #(MonoLifter, dict(n_landmarks=n_landmarks, d=3, robust=False, level="no", n_outliers=0)),
    #(WahbaLifter, dict(n_landmarks=n_landmarks, d=3, robust=False, level="no", n_outliers=0)),
    (MonoLifter, dict(n_landmarks=4, d=2, robust=True, level="xwT", n_outliers=1)),
    #(WahbaLifter, dict(n_landmarks=5, d=2, robust=True, level="xwT", n_outliers=1)),
    #(MonoLifter, dict(n_landmarks=n_landmarks, d=d, robust=False, level="no", n_outliers=0)),
    #(MonoLifter, dict(n_landmarks=n_landmarks, d=d, robust=True, level="xxT", n_outliers=1)),
    #(WahbaLifter, dict(n_landmarks=n_landmarks, d=d, robust=False, level="no", n_outliers=0)),
    #(WahbaLifter, dict(n_landmarks=n_landmarks, d=d, robust=True, level="xxT", n_outliers=0)),
    #(WahbaLifter, dict(n_landmarks=n_landmarks, d=d, robust=True, level="xwT", n_outliers=0)),
